...
class ContribucionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contribucion" do
    assert_difference('Contribucion.count') do
      post contribucions_url, params: { contribucion: { content: @contribucion.content, title: @contribucion.title, url: @contribucion.url } }
    end
  ...
  test "should update contribucion" do
    patch contribucion_url(@contribucion), params: { contribucion: { content: @contribucion.content, title: @contribucion.title, url: @contribucion.url } }
